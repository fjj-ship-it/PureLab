#!/bin/bash
# PureLab APK 本地重打包（副本工作区）：javac -> d8 -> aapt2 -> 注 dex -> zipalign -> keytool -> apksigner
# JDK 复用原工作区 tools（只读执行），资产来自本副本 app/
set -e

ROOT="/d/work Buddy/app/PureLab/purelab-apk"
TOOLS="/c/Users/willion/WorkBuddy/2026-09-01-10-27-48/purelab-apk/tools"
SDK="/c/Users/willion/AppData/Local/Android/Sdk"
BT="$SDK/build-tools/35.0.0"
PLAT="$SDK/platforms/android-35/android.jar"
JDK="$TOOLS/jdk-17.0.20.1+1/bin"
